...
public class Sistema {
     ...
     */
    public Object getAtributoUsuario(String login, String atributo) throws InvalidUserException, NullAttributeException {
        if(!usuarios.containsKey(login)){
            throw new InvalidUserException("Usuário não cadastrado.");
        }

        Object atributoUsuario = switch (atributo) {
